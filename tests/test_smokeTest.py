...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    self.driver.get("https://danielvilchez.github.io/cse270-teton/index.html")
    self.driver.set_window_size(1345, 1032)
  ...
  def test_directoryPage(self):
    self.driver.get("https://danielvilchez.github.io/cse270-teton/directory.html")
    self.driver.set_window_size(1200, 1000)
    self.driver.find_element(By.XPATH, "//a[contains(text(),\'Directory\')]").click()
  ...
  def test_homePage(self):
    self.driver.get("https://danielvilchez.github.io/cse270-teton/index.html")
    self.driver.set_window_size(1281, 840)
    ...
    self.driver.get("https://danielvilchez.github.io/cse270-teton/join.html")
  
  def test_joinPage(self):
    self.driver.get("https://danielvilchez.github.io/cse270-teton/index.html")
    self.driver.set_window_size(1200, 1032)
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").click()
    self.driver.find_element(By.NAME, "fname").send_keys("Name")
    ...
    self.driver.find_element(By.NAME, "bizname").send_keys("Bussines Name")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("Title or position")
